...
- **gate3_prereg_gate v15 十四层**：plan/ledger 冻结+时序自证、清树、
...
战役封存。评估器与 FWER 脚本为可复用资产（新家族预注册可直接套用
gate+evaluator+adjudication 三件套）。下一段方向由操作人另发工单
（已点名 CSI800 扩池方向），本档案不预设任何研究假设。
