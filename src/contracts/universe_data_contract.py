...
class UniverseDataContract:
    ...
    def validate_and_build_status(cls, request: UniverseContractInput) -> UniverseContractStatus:
        ...
        # Universe-specific: declared temporal_mode must match what the
        # manifest reports. Not abstracted into shared module because it
        # reads request.temporal_mode, which is Input-specific.
        ...
        # Universe-specific: membership-consistency check.
        ...
        errors.extend(
            _sv.check_temporal_basic(
                ...
                error_cls=UniverseDataContractError,
            )
        )
        errors.extend(
