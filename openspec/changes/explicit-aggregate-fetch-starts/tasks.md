...
- [x] 2.1 Document CLI migration, library mapping responsibilities and unchanged UI scope.
- [x] 2.2 Run focused tests, required full tests, import smoke, lint/types and OpenSpec validation; converge local review.
- [ ] 2.3 Publish the coherent PR, request Codex review and close actionable feedback before authorized merge.
