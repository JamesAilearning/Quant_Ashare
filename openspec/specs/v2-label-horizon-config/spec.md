# v2-label-horizon-config Specification

## Purpose

Make the Alpha158 label holding-horizon configurable (`label_horizon_days`,
default 1 = byte-identical to the historical hard-coded 2-day label) with
cache separation, horizon-driven embargo, and resume/audit visibility — the
enabler for the 阶段6 label-horizon campaign. Shipped by
`add-label-horizon-config` (#318); campaign concluded 2026-07-04 with a
pre-registered negative result (see docs/prereg/label_horizon_results.md).
